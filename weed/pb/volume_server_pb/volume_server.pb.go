...
type RepairVolumeTailRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	VolumeId      uint32                 `protobuf:"varint,1,opt,name=volume_id,json=volumeId,proto3" json:"volume_id,omitempty"`
	Apply         bool                   `protobuf:"varint,2,opt,name=apply,proto3" json:"apply,omitempty"`
	MarkWritable  bool                   `protobuf:"varint,3,opt,name=mark_writable,json=markWritable,proto3" json:"mark_writable,omitempty"`
	BackupDir     string                 `protobuf:"bytes,4,opt,name=backup_dir,json=backupDir,proto3" json:"backup_dir,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *RepairVolumeTailRequest) Reset() {
	*x = RepairVolumeTailRequest{}
	mi := &file_volume_server_proto_msgTypes[99]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *RepairVolumeTailRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RepairVolumeTailRequest) ProtoMessage() {}

func (x *RepairVolumeTailRequest) ProtoReflect() protoreflect.Message {
	mi := &file_volume_server_proto_msgTypes[99]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RepairVolumeTailRequest.ProtoReflect.Descriptor instead.
func (*RepairVolumeTailRequest) Descriptor() ([]byte, []int) {
	return file_volume_server_proto_rawDescGZIP(), []int{99}
}

func (x *RepairVolumeTailRequest) GetVolumeId() uint32 {
	if x != nil {
		return x.VolumeId
	}
	return 0
...
func (x *RepairVolumeTailRequest) GetApply() bool {
	if x != nil {
		return x.Apply
	}
	return false
...
func (x *RepairVolumeTailRequest) GetMarkWritable() bool {
	if x != nil {
		return x.MarkWritable
	}
	return false
}

func (x *RepairVolumeTailRequest) GetBackupDir() string {
	if x != nil {
		return x.BackupDir
	}
	return ""
...
type RepairVolumeTailResponse struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	Details        []string               `protobuf:"bytes,1,rep,name=details,proto3" json:"details,omitempty"`
	BackupFiles    []string               `protobuf:"bytes,2,rep,name=backup_files,json=backupFiles,proto3" json:"backup_files,omitempty"`
	Applied        bool                   `protobuf:"varint,3,opt,name=applied,proto3" json:"applied,omitempty"`
	MarkedWritable bool                   `protobuf:"varint,4,opt,name=marked_writable,json=markedWritable,proto3" json:"marked_writable,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}

func (x *RepairVolumeTailResponse) Reset() {
	*x = RepairVolumeTailResponse{}
	mi := &file_volume_server_proto_msgTypes[100]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *RepairVolumeTailResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RepairVolumeTailResponse) ProtoMessage() {}

func (x *RepairVolumeTailResponse) ProtoReflect() protoreflect.Message {
	mi := &file_volume_server_proto_msgTypes[100]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RepairVolumeTailResponse.ProtoReflect.Descriptor instead.
func (*RepairVolumeTailResponse) Descriptor() ([]byte, []int) {
	return file_volume_server_proto_rawDescGZIP(), []int{100}
}

func (x *RepairVolumeTailResponse) GetDetails() []string {
	if x != nil {
		return x.Details
	}
	return nil
...
func (x *RepairVolumeTailResponse) GetBackupFiles() []string {
	if x != nil {
...
func (x *RepairVolumeTailResponse) GetApplied() bool {
	if x != nil {
		return x.Applied
	}
	return false
...
func (x *RepairVolumeTailResponse) GetMarkedWritable() bool {
	if x != nil {
		return x.MarkedWritable
	}
	return false
}
...
const file_volume_server_proto_rawDesc = "" +
	...
	"\adetails\x18\x04 \x03(\tR\adetails\"\x90\x01\n" +
	"\x17RepairVolumeTailRequest\x12\x1b\n" +
	"\tvolume_id\x18\x01 \x01(\rR\bvolumeId\x12\x14\n" +
	"\x05apply\x18\x02 \x01(\bR\x05apply\x12#\n" +
	"\rmark_writable\x18\x03 \x01(\bR\fmarkWritable\x12\x1d\n" +
	"\n" +
	"backup_dir\x18\x04 \x01(\tR\tbackupDir\"\x9a\x01\n" +
	"\x18RepairVolumeTailResponse\x12\x18\n" +
	"\adetails\x18\x01 \x03(\tR\adetails\x12!\n" +
	"\fbackup_files\x18\x02 \x03(\tR\vbackupFiles\x12\x18\n" +
	"\aapplied\x18\x03 \x01(\bR\aapplied\x12'\n" +
	"\x0fmarked_writable\x18\x04 \x01(\bR\x0emarkedWritable\"l\n" +
	...
	"\vScrubVolume\x12$.volume_server_pb.ScrubVolumeRequest\x1a%.volume_server_pb.ScrubVolumeResponse\"\x00\x12k\n" +
	"\x10RepairVolumeTail\x12).volume_server_pb.RepairVolumeTailRequest\x1a*.volume_server_pb.RepairVolumeTailResponse\"\x00\x12b\n" +
...
var file_volume_server_proto_goTypes = []any{
	...
	(*RepairVolumeTailRequest)(nil),                      // 100: volume_server_pb.RepairVolumeTailRequest
	(*RepairVolumeTailResponse)(nil),                     // 101: volume_server_pb.RepairVolumeTailResponse
...
var file_volume_server_proto_depIdxs = []int32{
	...
	100, // 71: volume_server_pb.VolumeServer.RepairVolumeTail:input_type -> volume_server_pb.RepairVolumeTailRequest
	...
	81,  // 95: volume_server_pb.VolumeServer.ReadVolumeFileStatus:output_type -> volume_server_pb.ReadVolumeFileStatusResponse
	...
	62,  // 105: volume_server_pb.VolumeServer.VolumeEcShardsRebuild:output_type -> volume_server_pb.VolumeEcShardsRebuildResponse
	64,  // 106: volume_server_pb.VolumeServer.VolumeEcShardsCopy:output_type -> volume_server_pb.VolumeEcShardsCopyResponse
	66,  // 107: volume_server_pb.VolumeServer.VolumeEcShardsDelete:output_type -> volume_server_pb.VolumeEcShardsDeleteResponse
	68,  // 108: volume_server_pb.VolumeServer.VolumeEcShardsMount:output_type -> volume_server_pb.VolumeEcShardsMountResponse
	70,  // 109: volume_server_pb.VolumeServer.VolumeEcShardsUnmount:output_type -> volume_server_pb.VolumeEcShardsUnmountResponse
	72,  // 110: volume_server_pb.VolumeServer.VolumeEcShardRead:output_type -> volume_server_pb.VolumeEcShardReadResponse
	74,  // 111: volume_server_pb.VolumeServer.VolumeEcBlobDelete:output_type -> volume_server_pb.VolumeEcBlobDeleteResponse
	76,  // 112: volume_server_pb.VolumeServer.VolumeEcShardsToVolume:output_type -> volume_server_pb.VolumeEcShardsToVolumeResponse
	78,  // 113: volume_server_pb.VolumeServer.VolumeEcShardsInfo:output_type -> volume_server_pb.VolumeEcShardsInfoResponse
	89,  // 114: volume_server_pb.VolumeServer.VolumeTierMoveDatToRemote:output_type -> volume_server_pb.VolumeTierMoveDatToRemoteResponse
	91,  // 115: volume_server_pb.VolumeServer.VolumeTierMoveDatFromRemote:output_type -> volume_server_pb.VolumeTierMoveDatFromRemoteResponse
	93,  // 116: volume_server_pb.VolumeServer.VolumeServerStatus:output_type -> volume_server_pb.VolumeServerStatusResponse
	95,  // 117: volume_server_pb.VolumeServer.VolumeServerLeave:output_type -> volume_server_pb.VolumeServerLeaveResponse
	97,  // 118: volume_server_pb.VolumeServer.FetchAndWriteNeedle:output_type -> volume_server_pb.FetchAndWriteNeedleResponse
	99,  // 119: volume_server_pb.VolumeServer.ScrubVolume:output_type -> volume_server_pb.ScrubVolumeResponse
	101, // 120: volume_server_pb.VolumeServer.RepairVolumeTail:output_type -> volume_server_pb.RepairVolumeTailResponse
