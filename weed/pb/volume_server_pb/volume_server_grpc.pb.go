...
const (
	...
	VolumeServer_RepairVolumeTail_FullMethodName            = "/volume_server_pb.VolumeServer/RepairVolumeTail"
...
type VolumeServerClient interface {
	...
	RepairVolumeTail(ctx context.Context, in *RepairVolumeTailRequest, opts ...grpc.CallOption) (*RepairVolumeTailResponse, error)
...
func (c *volumeServerClient) RepairVolumeTail(ctx context.Context, in *RepairVolumeTailRequest, opts ...grpc.CallOption) (*RepairVolumeTailResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RepairVolumeTailResponse)
	err := c.cc.Invoke(ctx, VolumeServer_RepairVolumeTail_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type VolumeServerServer interface {
	...
	RepairVolumeTail(context.Context, *RepairVolumeTailRequest) (*RepairVolumeTailResponse, error)
...
func (UnimplementedVolumeServerServer) RepairVolumeTail(context.Context, *RepairVolumeTailRequest) (*RepairVolumeTailResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RepairVolumeTail not implemented")
}
...
func _VolumeServer_RepairVolumeTail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RepairVolumeTailRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(VolumeServerServer).RepairVolumeTail(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: VolumeServer_RepairVolumeTail_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VolumeServerServer).RepairVolumeTail(ctx, req.(*RepairVolumeTailRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var VolumeServer_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RepairVolumeTail",
			Handler:    _VolumeServer_RepairVolumeTail_Handler,
		},
		{
